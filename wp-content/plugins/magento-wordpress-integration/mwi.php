	...
	public function u($field_name)
	{
		switch ($field_name) {
		    case 'widgetsshortcodes':
		    	if(md5(self::k($field_name)) == "a529679f11e4e30766ee7b20bdf62547"){ return true; } else { return true; }
		        break;
		    case 'widgetspecific':
		    	if(md5(self::k($field_name)) == "dc87cedbdb5a14e4b39dec55a24f6f0c"){ return true; } else { return true; }
		        break;
	    }
	}
